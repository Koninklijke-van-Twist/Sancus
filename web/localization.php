...
const TRANSLATIONS = [
    'nl' => [
        ...
        'sancus.hero.subtitle' => 'Zoek op contract- of projectnummer en bekijk de projectposten.',
        'sancus.label.company' => 'Bedrijf',
        'sancus.label.contract' => 'Contract- of projectnummer',
        'sancus.label.date_from' => 'Datum van',
        'sancus.label.date_to' => 'Datum tot',
        'sancus.placeholder.contract' => 'Bijv. CT26000184 of PRJ2602980',
        'sancus.btn.search' => 'Zoeken',
        'sancus.btn.collapse_all' => 'Alles inklappen',
        'sancus.btn.expand_all' => 'Alles openklappen',
        'sancus.btn.settings' => 'Instellingen',
        'sancus.btn.refresh' => 'Ververs gegevens',
        'sancus.settings.title' => 'Voorkeuren',
        'sancus.settings.include_unbooked_costs' => 'Ongeboekte kosten ook meetellen',
        'sancus.settings.close' => 'Sluiten',
        'sancus.section.posten' => 'Projectposten',
        'sancus.data_age' => 'Gegevens zijn %s oud',
        'sancus.meta.contract' => 'Contract',
        'sancus.meta.projects' => 'Projecten',
        'sancus.meta.projects_count' => 'projecten',
        'sancus.meta.customer' => 'Klant',
        'sancus.meta.lines' => 'Regels',
        'sancus.meta.cost' => 'Kosten',
        'sancus.meta.revenue' => 'Gefactureerd',
        'sancus.meta.profit' => 'Winst',
        'sancus.meta.profit_pct' => 'Winst %',
        'sancus.meta.material' => 'Totaal materiaal',
        'sancus.meta.hours' => 'Totaal uren',
        'sancus.meta.kilometers' => 'Totaal kilometers',
        ...
        'sancus.col.revenue' => 'Gefactureerd',
        'sancus.col.profit' => 'Winst',
        ...
        'sancus.error.project_not_found' => 'Geen projecten gevonden voor dit contract- of projectnummer.',
        ...
        'sancus.progress.resolve' => 'Zoekopdracht opzoeken…',
        'sancus.progress.posten' => 'Projectposten laden…',
        'sancus.progress.posten_done' => 'Projectposten geladen',
        'sancus.progress.contract_planning' => 'Contractplanning laden…',
        'sancus.progress.job_planning' => 'Ongeboekte kosten laden…',
        'sancus.progress.job_planning_done' => 'Ongeboekte kosten geladen',
        'sancus.progress.done' => 'Overzicht samenstellen…',
        'sancus.progress.error' => 'Laden mislukt',
    ],
    ...
    'en' => [
        ...
        'sancus.hero.subtitle' => 'Search by contract or project number and view the project entries.',
        'sancus.label.company' => 'Company',
        'sancus.label.contract' => 'Contract or project number',
        'sancus.label.date_from' => 'Date from',
        'sancus.label.date_to' => 'Date to',
        'sancus.placeholder.contract' => 'e.g. CT26000184 or PRJ2602980',
        'sancus.btn.search' => 'Search',
        'sancus.btn.collapse_all' => 'Collapse all',
        'sancus.btn.expand_all' => 'Expand all',
        'sancus.btn.settings' => 'Settings',
        'sancus.btn.refresh' => 'Refresh data',
        'sancus.settings.title' => 'Preferences',
        'sancus.settings.include_unbooked_costs' => 'Also include unposted costs',
        'sancus.settings.close' => 'Close',
        'sancus.section.posten' => 'Project entries',
        'sancus.data_age' => 'Data is %s old',
        'sancus.meta.contract' => 'Contract',
        'sancus.meta.projects' => 'Projects',
        'sancus.meta.projects_count' => 'projects',
        'sancus.meta.customer' => 'Customer',
        'sancus.meta.lines' => 'Lines',
        'sancus.meta.cost' => 'Costs',
        'sancus.meta.revenue' => 'Invoiced',
        'sancus.meta.profit' => 'Profit',
        'sancus.meta.profit_pct' => 'Profit %',
        'sancus.meta.material' => 'Total material',
        'sancus.meta.hours' => 'Total hours',
        'sancus.meta.kilometers' => 'Total kilometers',
        'sancus.col.project' => 'Project',
        ...
        'sancus.col.revenue' => 'Invoiced',
        'sancus.col.profit' => 'Profit',
        ...
        'sancus.error.project_not_found' => 'No projects found for this contract or project number.',
        ...
        'sancus.progress.resolve' => 'Resolving search…',
        'sancus.progress.posten' => 'Loading project entries…',
        'sancus.progress.posten_done' => 'Project entries loaded',
        'sancus.progress.contract_planning' => 'Loading contract planning…',
        'sancus.progress.job_planning' => 'Loading unposted costs…',
        'sancus.progress.job_planning_done' => 'Unposted costs loaded',
        'sancus.progress.done' => 'Building overview…',
        'sancus.progress.error' => 'Loading failed',
    ],
    ...
    'de' => [
        ...
        'sancus.hero.subtitle' => 'Suche nach Vertrags- oder Projektnummer und zeige die Projektposten.',
        'sancus.label.company' => 'Unternehmen',
        'sancus.label.contract' => 'Vertrags- oder Projektnummer',
        'sancus.label.date_from' => 'Datum von',
        'sancus.label.date_to' => 'Datum bis',
        'sancus.placeholder.contract' => 'z. B. CT26000184 oder PRJ2602980',
        'sancus.btn.search' => 'Suchen',
        'sancus.btn.collapse_all' => 'Alles einklappen',
        'sancus.btn.expand_all' => 'Alles ausklappen',
        'sancus.btn.settings' => 'Einstellungen',
        'sancus.btn.refresh' => 'Daten aktualisieren',
        'sancus.settings.title' => 'Einstellungen',
        'sancus.settings.include_unbooked_costs' => 'Ungebuchte Kosten mitzählen',
        'sancus.settings.close' => 'Schließen',
        'sancus.section.posten' => 'Projektposten',
        'sancus.data_age' => 'Daten sind %s alt',
        'sancus.meta.contract' => 'Vertrag',
        'sancus.meta.projects' => 'Projekte',
        'sancus.meta.projects_count' => 'Projekte',
        'sancus.meta.customer' => 'Kunde',
        'sancus.meta.lines' => 'Zeilen',
        'sancus.meta.cost' => 'Kosten',
        'sancus.meta.revenue' => 'Fakturiert',
        'sancus.meta.profit' => 'Gewinn',
        'sancus.meta.profit_pct' => 'Gewinn %',
        'sancus.meta.material' => 'Gesamt Material',
        'sancus.meta.hours' => 'Gesamt Stunden',
        'sancus.meta.kilometers' => 'Gesamt Kilometer',
        ...
        'sancus.col.cost' => 'Kosten',
        'sancus.col.revenue' => 'Fakturiert',
        'sancus.col.profit' => 'Gewinn',
        ...
        'sancus.error.project_not_found' => 'Keine Projekte für diese Vertrags- oder Projektnummer gefunden.',
        ...
        'sancus.progress.resolve' => 'Suche wird aufgelöst…',
        'sancus.progress.posten' => 'Projektposten werden geladen…',
        'sancus.progress.posten_done' => 'Projektposten geladen',
        'sancus.progress.contract_planning' => 'Vertragsplanung wird geladen…',
        'sancus.progress.job_planning' => 'Ungebuchte Kosten werden geladen…',
        'sancus.progress.job_planning_done' => 'Ungebuchte Kosten geladen',
        'sancus.progress.done' => 'Übersicht wird erstellt…',
        'sancus.progress.error' => 'Laden fehlgeschlagen',
    ],
    ...
    'fr' => [
        ...
        'sancus.hero.subtitle' => 'Recherchez par numéro de contrat ou de projet et consultez les écritures projet.',
        'sancus.label.company' => 'Société',
        'sancus.label.contract' => 'Numéro de contrat ou de projet',
        'sancus.label.date_from' => 'Date de début',
        'sancus.label.date_to' => 'Date de fin',
        'sancus.placeholder.contract' => 'ex. CT26000184 ou PRJ2602980',
        'sancus.btn.search' => 'Rechercher',
        'sancus.btn.collapse_all' => 'Tout réduire',
        'sancus.btn.expand_all' => 'Tout développer',
        'sancus.btn.settings' => 'Paramètres',
        'sancus.btn.refresh' => 'Actualiser les données',
        'sancus.settings.title' => 'Préférences',
        'sancus.settings.include_unbooked_costs' => 'Inclure aussi les coûts non comptabilisés',
        'sancus.settings.close' => 'Fermer',
        'sancus.section.posten' => 'Écritures projet',
        'sancus.data_age' => 'Données âgées de %s',
        'sancus.meta.contract' => 'Contrat',
        'sancus.meta.projects' => 'Projets',
        'sancus.meta.projects_count' => 'projets',
        'sancus.meta.customer' => 'Client',
        'sancus.meta.lines' => 'Lignes',
        'sancus.meta.cost' => 'Coûts',
        'sancus.meta.revenue' => 'Facturé',
        'sancus.meta.profit' => 'Bénéfice',
        'sancus.meta.profit_pct' => 'Bénéfice %',
        'sancus.meta.material' => 'Total matériel',
        'sancus.meta.hours' => 'Total heures',
        'sancus.meta.kilometers' => 'Total kilomètres',
        ...
        'sancus.col.revenue' => 'Facturé',
        'sancus.col.profit' => 'Bénéfice',
        ...
        'sancus.error.project_not_found' => 'Aucun projet trouvé pour ce numéro de contrat ou de projet.',
        ...
        'sancus.progress.resolve' => 'Résolution de la recherche…',
        'sancus.progress.posten' => 'Chargement des écritures projet…',
        'sancus.progress.posten_done' => 'Écritures projet chargées',
        'sancus.progress.contract_planning' => 'Chargement de la planification contrat…',
        'sancus.progress.job_planning' => 'Chargement des coûts non comptabilisés…',
        'sancus.progress.job_planning_done' => 'Coûts non comptabilisés chargés',
        'sancus.progress.done' => 'Préparation de l’aperçu…',
        'sancus.progress.error' => 'Échec du chargement',
    ],
];
/**
 * Functies
