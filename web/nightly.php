...
$result = project_warm_contract_searches(SANCUS_NIGHTLY_SEARCH_MAX_AGE, SANCUS_NIGHTLY_CACHE_TTL);
...
echo json_encode([
    'success' => $failed === [],
    'job' => 'nightly',
    'window_seconds' => SANCUS_NIGHTLY_SEARCH_MAX_AGE,
    'ttl_seconds' => SANCUS_NIGHTLY_CACHE_TTL,
